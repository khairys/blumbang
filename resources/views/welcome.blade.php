<x-publik-layout>
    ...
    <section class="py-20 bg-white" data-aos="fade-up">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Mengenal Desa Blumbang</h2>
            <div class="text-gray-600 text-lg leading-relaxed space-y-4 mb-10">
                <p>
            ...
            <a href="{{ route('publik.profil') }}" class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold px-8 py-4 rounded-full transition-all duration-300 hover:-translate-y-1 shadow-lg shadow-green-500/30">
                Kenali Desa Blumbang
    ...
    <section class="py-16 bg-gray-50 border-y border-gray-100" data-aos="fade-up">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center">
                <a href="{{ route('publik.pengumuman.index') }}" class="inline-flex items-center gap-2 text-green-600 hover:text-green-700 font-bold border-b-2 border-green-600/30 hover:border-green-600 pb-1 transition-colors">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                @if(isset($groupedLayanans) && $groupedLayanans->isNotEmpty())
                    @foreach($groupedLayanans as $kategori => $layanans)
                        <a href="{{ route('publik.layanan.kategori', Str::slug($kategori)) }}" class="group bg-gray-50 rounded-3xl p-8 border border-gray-100 hover:border-emerald-200 hover:bg-emerald-50/30 transition-all duration-300 relative overflow-hidden flex flex-col h-full card-hover">
                            <h3 class="text-xl font-bold text-gray-900 mb-6 group-hover:text-emerald-700 transition-colors">{{ $kategori }}</h3>
                            
                            <ul class="space-y-3 mb-8 w-full flex-1">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="fade-up" data-aos-delay="100">
                @if(isset($beritas) && $beritas->isNotEmpty())
                    ...
                    <a href="{{ route('publik.berita.show', $b->slug) }}" class="block card-hover bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm transition-shadow group">
                        <!-- Thumbnail -->
                        <div class="h-52 bg-gradient-to-br from-green-800 to-emerald-600 relative overflow-hidden">
                            @if ($b->thumbnail)
                        ...
                        <div class="p-6 flex flex-col h-full">
                            <p class="text-xs text-green-600 font-bold mb-2 uppercase tracking-wide">
                                {{ $b->category ? $b->category->name : 'Kesehatan Masyarakat' }} <span class="text-gray-300 mx-1">·</span> <span class="text-gray-400 font-medium">{{ $b->created_at->format('d F Y') }}</span>
                            </p>
                            <h3 class="font-bold text-gray-900 text-xl mb-3 leading-snug line-clamp-2 group-hover:text-green-600 transition-colors">{{ $b->title }}</h3>
            ...
            <div class="text-center mt-12">
                <a href="{{ route('publik.berita.index') }}" class="inline-flex items-center gap-2 text-green-600 hover:text-green-700 font-bold border-b-2 border-green-600/30 hover:border-green-600 pb-1 transition-colors">
                    Lihat Semua Berita
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                </a>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" data-aos="fade-up" data-aos-delay="100">
                @if(isset($potensi_desa) && $potensi_desa->isNotEmpty())
                    ...
                    <a href="{{ route('publik.potensi-desa.show', $pot->slug) }}" class="block card-hover rounded-2xl overflow-hidden border border-gray-100 shadow-sm bg-gray-50 hover:bg-white hover:border-emerald-200 transition-all group p-6">
                        ...
                        <h3 class="font-bold text-xl text-gray-900 mb-3 group-hover:text-emerald-700 transition-colors">{{ $pot->title }}</h3>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                ...
                <div class="lg:col-span-5 relative z-10">
                    <div class="inline-flex items-center gap-2 bg-white text-amber-600 border border-amber-200 text-xs font-bold px-4 py-1.5 rounded-full mb-6 shadow-sm">
                        <span class="text-sm">🌽</span> Potensi Pangan Lokal
                    </div>
                ...
                <div>
                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            ...
                            @if(isset($pengaturan) && $pengaturan->maps_url)
                            <a href="{{ $pengaturan->maps_url }}" target="_blank" class="inline-flex items-center gap-2 text-green-600 hover:text-green-700 font-bold transition-colors">
