        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div class="lg:col-span-2 space-y-5">
                    ...
                    <div class="space-y-4">
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 leading-relaxed">Jl. Raya Blumbang, Desa Blumbang<br>Kecamatan Klego, Kabupaten Boyolali<br>Jawa Tengah 57386</p>
                            </div>
                        </div>
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <a href="tel:02761234567" class="text-sm text-blue-600 hover:underline">(0276) 123-4567</a>
                            </div>
                        </div>
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <a href="mailto:desa@blumbang.desa.id" class="text-sm text-blue-600 hover:underline">desa@blumbang.desa.id</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div class="flex gap-3">
                        <a href="#" class="flex items-center gap-2.5 bg-blue-50 hover:bg-blue-100 text-blue-700 text-sm font-medium px-4 py-2.5 rounded-xl transition-colors">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                            Facebook
                        </a>
                        <a href="#" class="flex items-center gap-2.5 bg-pink-50 hover:bg-pink-100 text-pink-700 text-sm font-medium px-4 py-2.5 rounded-xl transition-colors">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                    <div class="h-72 bg-gray-100 flex items-center justify-center">
                        <div class="text-center text-gray-400">
                            ...
                            <p class="text-xs text-gray-400 mt-1">Desa Blumbang, Kecamatan Klego<br>Kabupaten Boyolali, Jawa Tengah</p>
                            <a href="https://maps.google.com/?q=Desa+Blumbang+Klego+Boyolali" target="_blank"
                               class="inline-flex items-center gap-1.5 mt-4 bg-green-600 text-white text-xs font-medium px-4 py-2 rounded-xl hover:bg-green-700 transition-colors">
