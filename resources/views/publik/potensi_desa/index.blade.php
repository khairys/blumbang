<x-publik-layout>
    ...
    <div class="bg-gradient-to-br from-emerald-800 via-emerald-700 to-green-600 pt-16 pb-24 relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <nav class="text-sm text-emerald-100 mb-6 flex items-center gap-2"><a href="{{ route('beranda') }}" class="hover:text-white transition-colors">Beranda</a> <svg class="w-3 h-3 text-emerald-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg><span class="text-white">Potensi Desa</span></nav>
            <h1 class="text-4xl md:text-5xl font-extrabold text-white tracking-tight">Potensi Desa Blumbang</h1>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <article class="card-hover bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm transition-all duration-200 flex flex-col">
        ...
        <div class="py-12 text-center bg-white rounded-2xl border border-emerald-100 shadow-sm">
            ...
            <p class="text-gray-500 font-medium">Belum ada potensi desa yang dipublikasikan.</p>
        </div>
        @endif
    </div>
</x-publik-layout>