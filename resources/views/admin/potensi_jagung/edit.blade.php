            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-5">
                ...
                <div class="space-y-4">
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
                        ...
                        <div x-data="{ photoPreview: '{{ isset($produk) && $produk->thumbnail ? Storage::url($produk->thumbnail) : '' }}' }">
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">Foto / Thumbnail <span class="text-red-500">*</span></label>
                            
                            <div class="relative w-full h-48 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 flex items-center justify-center overflow-hidden group hover:border-yellow-400 transition-colors cursor-pointer"
