                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mb-2 flex items-center gap-3">
                            <img src="{{ Storage::url($pengaturan->favicon) }}" alt="Favicon" class="w-8 h-8 object-contain bg-gray-50 p-1 rounded border border-gray-200">
                        ...
                        <p class="text-xs text-gray-400 mt-1">Format PNG atau ICO. Ukuran disarankan 32x32 px. Max 500KB.</p>
                    </div>
